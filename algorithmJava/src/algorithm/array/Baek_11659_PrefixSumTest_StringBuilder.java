...
public class Baek_11659_PrefixSumTest_StringBuilder {
...
//		System.out.println(Arrays.toString(sumArray)); - 배열을 한번에 확인하는 방법
		...
		//System.out.println이 리소스를 많이 사용하기 때문에 실행시간이 더 걸린다. 이를 최적화 하기 위해서
		//출력할 구간합을 하나의 문자열로 만들어서 한 번만 sysout으로 출력하기
		StringBuilder sb = new StringBuilder();//누적합을 추가할 변수
		...
		//Input/Output스트림 클래스들은 사용이 끝나면 자원반납
		br.close();
